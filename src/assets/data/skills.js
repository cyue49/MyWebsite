export const skills = [
    {
        ...
        list: {
            en: [
                ...
                'Multiplatform application development using React Native with Expo or using Kotlin Multiplatform and Compose Multiplatform.'
            ],
            fr: [
                ...
                'Développement d\'applications multiplateformes en utilisant React Native avec Expo ou en utilisant Kotlin Multiplateforme et Compose Multiplateforme.'
            ]
        }
    },
    {
